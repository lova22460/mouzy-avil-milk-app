...
<style>body{font-family:Arial,sans-serif;background:linear-gradient(180deg,#fffef2,#fff6ad 42%,#fff 100%);margin:0;padding:18px;color:#171717}body>h2{text-align:center;font-weight:900}.history{max-width:760px;margin:12px auto;padding:16px 18px;background:rgba(255,255,255,.97);border:1px solid #eee2a0;border-left:6px solid #e0c500;border-radius:16px;box-shadow:0 6px 18px rgba(70,55,0,.07)}.history .item{font-weight:800;font-size:17px}.history .time{color:#777;font-size:13px;margin-top:6px}form button{background:#171717;color:#fff;border:0;border-radius:11px;padding:11px 16px;font-weight:800;cursor:pointer}p{text-align:center}</style>
</head>
...
/* MOUZY DESIGN POLISH V2 — DESIGN ONLY */
:root{--mouzy-yellow:#ffe500;--mouzy-green:#1f9d4a;--mouzy-red:#dc3545;--mouzy-ink:#171717;--mouzy-soft:#fffdf0;--mouzy-border:#eee4a6}
body{font-family:Arial,sans-serif;background:linear-gradient(180deg,#fffef4 0%,#fffbe2 48%,#ffffff 100%);color:var(--mouzy-ink);padding:18px 14px}
h1{font-weight:900;letter-spacing:.4px;text-shadow:0 1px 0 #fff;margin:8px auto 18px;max-width:900px}
.section{background:rgba(255,255,255,.96);border:1px solid var(--mouzy-border);border-radius:20px;box-shadow:0 8px 24px rgba(60,50,0,.08);padding:18px;margin:0 auto 20px;max-width:900px}
.section h2{margin:2px 0 8px;font-weight:900}.small{color:#777}.dashboard{max-width:900px}.dashboard-title{padding:4px 2px}.live-pill{background:#eaf8ee;border:1px solid #bfe8ca;color:#187a39}
.dashboard-grid{gap:12px}.dash-card{border:1px solid #eee5a7;border-radius:18px;background:linear-gradient(145deg,#fff,#fffdf1);box-shadow:0 5px 16px rgba(60,50,0,.07);transition:transform .15s}.dash-card:hover{transform:translateY(-2px)}.dash-number{font-size:30px}.dash-out{border-left:6px solid var(--mouzy-red)}.dash-limited{border-left:6px solid #f2bd00}.dash-on{border-left:6px solid var(--mouzy-green)}.dash-menu{border-left:6px solid #e1c900}
.menu-category,.ingredient-master-category{background:#fff;border:1px solid #eee5a7;border-radius:16px;box-shadow:0 3px 10px rgba(60,50,0,.05);overflow:hidden}.menu-category summary,.ingredient-master-category summary{background:linear-gradient(90deg,#fffdf0,#fff);padding:16px}.menu-category[open] summary,.ingredient-master-category[open] summary{background:#fffbea}.category-items{background:#fff}.menu-item{padding:13px 6px;border-bottom:1px solid #f0edda}.menu-item:last-child,.ingredient-master-row:last-child{border-bottom:0}.ingredient-master-row{padding:13px 6px;border-bottom:1px solid #f0edda}.control-row{padding:10px 0;border-bottom:1px dashed #eee3a1}.item-controls button,.control-row button{box-shadow:0 2px 5px rgba(0,0,0,.08)}
.card{background:#fffdf5;border:1px solid #eee5b4;box-shadow:0 3px 10px rgba(60,50,0,.05)}.card.out{border-left:6px solid var(--mouzy-red)}.card.limited{border-left:6px solid #f2bd00}.dependency-group{background:#fffbea;border:1px solid #f0e5a4}.ingredient-alert summary{padding:3px 2px}
.dot-menu>button{background:var(--mouzy-ink);box-shadow:0 4px 12px rgba(0,0,0,.2)}.dot-panel{border:1px solid #eee3a1;background:#fffef7}.dot-panel a{padding:13px 15px}.dot-panel a:hover{background:#fff3a8}
@media(max-width:650px){body{padding:12px 10px}.section{padding:14px;border-radius:18px}.dashboard-grid{gap:9px}.dash-card{border-radius:15px}.dash-number{font-size:26px}.menu-category summary,.ingredient-master-category summary{padding:14px 12px}.menu-item,.ingredient-master-row{padding:12px 4px}}
</style>
</head>
<body>
...
/* MOUZY STAFF VIEW DESIGN — DESIGN ONLY */
body{font-family:Arial,sans-serif;background:linear-gradient(180deg,#fffef2,#fff6ad 42%,#fff 100%);color:#171717;padding:16px 12px}.section{background:rgba(255,255,255,.97);border:1px solid #eee2a0;border-radius:20px;box-shadow:0 8px 24px rgba(70,55,0,.08);padding:18px;margin-bottom:20px}.section h2{font-weight:900;margin-top:2px}.card{background:#fffdf5;border:1px solid #eee2a0;border-radius:15px;padding:14px;margin:11px 0;box-shadow:0 3px 10px rgba(70,55,0,.05)}.card.out{border-left:6px solid #dc3545}.card.limited{border-left:6px solid #f2bd00}.menu-category{background:#fff;border:1px solid #eee2a0;border-radius:16px;box-shadow:0 3px 10px rgba(70,55,0,.05)}.menu-category summary{background:linear-gradient(90deg,#fffdf0,#fff);padding:16px}.menu-category[open] summary{background:#fffbea}.menu-item{padding:13px 5px;border-bottom:1px solid #f0edda}.dependency-group{background:#fffbea;border:1px solid #f0e5a4;border-radius:10px;padding:9px 11px}.dot-menu>button{background:#171717;box-shadow:0 4px 12px rgba(0,0,0,.2)}.dot-panel{border:1px solid #eee2a0;background:#fffef7}.dot-panel a{padding:13px 15px}.dot-panel a:hover{background:#fff3a8}h1{text-align:center;font-weight:900;margin:8px auto 18px;max-width:850px}.small{color:#777}@media(max-width:650px){body{padding:12px 9px}.section{padding:14px;border-radius:18px}}
</style></head><body>
